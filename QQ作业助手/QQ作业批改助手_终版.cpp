...
Dim dxk,qunming,daanming // 多选框，群名，文件名
...
Dim choice_tiqu // 存放提取的选择题
Dim fillemp_tiqu(100) // 存放提取中的填空题
Dim jianda_tiqu(100) // 存放提取中的简答题
...
//TracePrint lujing
dxk = ReadUIConfig("多选框1") // 判断多选框是否选中
//TracePrint dxk
